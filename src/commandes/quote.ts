...
module.exports = {
    ...
    execute: async(client, interaction) => {
        ...
        const embed = new MessageEmbed()
            ...
            .addField("\u200B", `Dixit ${interaction.targetMessage.guild.members.cache.get(interaction.targetMessage.author.id).nickname} le <t:${Math.round(interaction.targetMessage.createdTimestamp/1000)}:F>\n[Message original](https://discord.com/channels/${interaction.targetMessage.channel.id}/${interaction.targetMessage.id})`)
